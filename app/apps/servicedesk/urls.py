...
urlpatterns = [
    ...
    path('tickets/<int:pk>/pdf/', views.ticket_pdf_view, name='ticket_pdf'), # Nova URL para PDF do Ticket
    ...
    path('workorders/<int:pk>/pdf/', views.work_order_pdf_view, name='work_order_pdf'), # Nova URL para PDF da WorkOrder
